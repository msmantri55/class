...
public class MapReduce {
	...
	public Cons mapreduce (String filename, String param) throws java.io.FileNotFoundException {
		...
		for (Map.Entry item : intvals) {
			reducer.reduce((String) item.getKey(), (Cons) Cons.first((Cons) item.getValue()), this);
		}
	...
	public void collect_map(String key, Cons value) {
		...
		if (ptrs == null) {
			...
			Cons.setrest((Cons) Cons.second(ptrs), newptr);
			Cons.setfirst((Cons) Cons.rest(ptrs), newptr);
		}
	}
