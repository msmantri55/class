public class graphtest {
	public static Graph texas = new Graph(
		Cons.readlist(
			Cons.list(
	...
	public static void dtest (String start, String goal) {
		...
		System.out.println("Road Distance " + start + " to " + goal + " = " + texas.vertex(goal).cost());
		Cons route = texas.pathto(goal);
		Cons.printanswer("Route to " + goal + " = ", route);
		System.out.println();
	}

	public static void atest (String start, String goal, String hname, Heuristic h) {
	...
	public static void main (String[] args) {
		...
		System.out.println("Great-Circle Distance Austin to Muleshoe = " + texas.vertex("austin").distanceTo(texas.vertex("muleshoe")));
		System.out.println();
		...
		System.out.println("edgecost austin to temple = " + texas.edgecost(texas.vertex("austin"), texas.vertex("temple")));
		Cons routem = texas.pathto("muleshoe");
		Cons.printanswer("Route Austin to Muleshoe = ", routem);

		System.out.println("pathcost austin to muleshoe = " + texas.pathcost(texas.vertex("muleshoe")));
		System.out.println("Total cost of all roads = " + texas.totalcost());
